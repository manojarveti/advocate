    ...
    ButtonDirective.prototype.ngOnInit = function () {
        ...
        if (this.service) {
            this.buttonLookChangeSubscription = this.service.buttonLookChange
                .pipe(filter$1(function (look) { return look !== 'default'; }))
...
var ListButton = /** @class */ (function () {
    ...
    ListButton.prototype.subscribeComponentBlurredEvent = function () {
        ...
        this._zone.runOutsideAngular(function () {
            _this.documentClick = fromEvent$1(document, 'click').pipe(filter$1(function (event) {
                return !_this.wrapperContains(event.target);
            }));
            _this.tabSubscription = _this.navigationService.tab.pipe(filter$1(function () { return _this._isFocused; })).subscribe(_this.handleTab.bind(_this));
            _this.componentBlurredSubscription = merge$1(_this.documentClick, _this.wrapperBlurred).pipe(filter$1(function () { return _this._isFocused; })).subscribe(function () { return _this._zone.run(function () { return _this.blurWrapper(); }); });
        });
    };
    ListButton.prototype.subscribeNavigationEvents = function () {
        ...
        this.closeSubscription = merge$1(this.navigationService.close, this.navigationService.esc).subscribe(function () { return _this.focusWrapper(); });
    };
