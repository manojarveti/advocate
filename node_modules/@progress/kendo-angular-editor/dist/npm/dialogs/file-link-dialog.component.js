...
var FileLinkDialogComponent = /** @class */ (function (_super) {
    ...
    function FileLinkDialogComponent(dialog) {
        ...
        _this.linkForm = new forms_1.FormGroup({
            ...
            'text': new forms_1.FormControl('', forms_1.Validators.required),
    ...
    FileLinkDialogComponent.prototype.setData = function (state) {
        ...
        var linkMark = prosemirror_utils_1.getMark(state, schema_1.schema.marks.link);
        if (linkMark) {
        ...
        if (!state.selection.empty) {
            this.linkForm.patchValue({
                'text': prosemirror_utils_1.getSelectionText(state)
            });
        }
    };
    FileLinkDialogComponent.prototype.setLinkText = function (state) {
        ...
        if (selection.empty && selection.$cursor) {
            ...
            return prosemirror_utils_1.getSelectionText(state);
        }
    };
